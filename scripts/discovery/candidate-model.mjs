...
const DATA_DOMAINS = Object.freeze({
  ...
  science: ['scientific', 'genomic', 'protein', 'chemical', 'chemistry', 'material', 'clinical trial', 'biomedical', 'energy', 'electricity', 'petroleum', 'natural gas', 'coal'],
  geospatial: ['geospatial', 'geographic', 'mapping', 'map data', 'location data', 'weather', 'climate', 'earthquake', 'seismic', 'geology'],
